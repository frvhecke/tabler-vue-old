<template>
  <CardWrapper :background_color="background_color" :text_color="text_color" :text_color_auto="text_color_auto" status="bottom" :status_color="status_color">
    <template #header v-if="header_active">
      <slot name="header"></slot>
    </template>
    <slot></slot>
    <template #footer v-if="footer_active">
